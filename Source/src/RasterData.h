...
namespace RasterData
{
  ...
  struct Varying
  {
...
#ifdef SIMD_ARM_NEON
    static void InterpolateARM(const float32x4_t & iAttrib1, const float32x4_t & iAttrib2, const float32x4_t & iAttrib3, const float iWeights[3], Varying & oResult)
    {
      float32x4_t Weights[3] = { _mm256_set1_ps(iWeights[0]), _mm256_set1_ps(iWeights[1]), _mm256_set1_ps(iWeights[2]) };

      float32x4_t interpolResult;
      SIMDUtils::InterpolateAVX2(iAttrib1, iAttrib2, iAttrib3, Weights, interpolResult);
    ...
    {
      float32x4_t attrib1 = _mm256_set_ps(iAttrib1._WorldPos.x, iAttrib1._WorldPos.y, iAttrib1._WorldPos.z, iAttrib1._UV.x, iAttrib1._UV.y, iAttrib1._Normal.x, iAttrib1._Normal.y, iAttrib1._Normal.z);
      float32x4_t attrib2 = _mm256_set_ps(iAttrib2._WorldPos.x, iAttrib2._WorldPos.y, iAttrib2._WorldPos.z, iAttrib2._UV.x, iAttrib2._UV.y, iAttrib2._Normal.x, iAttrib2._Normal.y, iAttrib2._Normal.z);
      float32x4_t attrib3 = _mm256_set_ps(iAttrib3._WorldPos.x, iAttrib3._WorldPos.y, iAttrib3._WorldPos.z, iAttrib3._UV.x, iAttrib3._UV.y, iAttrib3._Normal.x, iAttrib3._Normal.y, iAttrib3._Normal.z);
