...
void RenderDemo( out vec4 color, in vec2 coord )
{
  float musictime = u_Time;
  ...
  vec2 uv = (coord.xy/u_Resolution.xy-.5)*vec2(u_Resolution.x,-u_Resolution.y)/u_Resolution.y;
  ...
  //////////////////////
    ...
    color = vec4(col-max(musictime-107.,0.),1);
}

void RenderToTexture()
{
  RenderDemo(fragColor, gl_FragCoord .xy);
}
